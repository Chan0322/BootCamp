...
-- 상호연관쿼리(상관쿼리)
-- 메인쿼리의 컬럼을 서브쿼리에서도 적용하여 사용하는 서브쿼리문.
 ...
 * 
 * 제약조건:
 * 		테이블에 데이터를 저장하고자 할 때 지켜야 할 규칙, 제약
 * 
 * NOT NULL 	- NULL 값 허용하지 않는다.(필수입력사항)
 * UNIQUE		- 중복값 허용하지 않는다.
 * CHECK		- 지정한 입력값 외에는 저장하지 못하게 막는 조건.
 * PRIMARY KEY	- (NOT NULL + UNIQUE) 기본키
 * 					테이블내에서 행을(데이터, 로우)를 구분할 수 있는 고유 값
...
FROM USER_CONSTRAINTS C1
JOIN USER_CONSTRAINTS C2 ON(C1.CONSTRAINT_NAME = C2.CONSTRAINT_NAME)
WHERE C1.TABLE_NAME = 'USER_NONCONS';
...
--SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(MULTI.SYS_C007473)에 위배됩니다
INSERT INTO USER_UNIQUE
VALUES(1,'USER01','PASS01','홍길동','남');
...
-- 두개 이상의 컬럼을 제약조건으로 묶어 적용, 반드시 테이블 레벨에서 조건 선언
-- NO	ID
-- 1	U1
-- 1	U2
-- 2	U1
...
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(MULTI.SYS_C007475)에 위배됩니다
...
INSERT INTO USER_CHECK VALUES(1,'USER02','PASS01','홍길동','남자');

-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(MULTI.SYS_C007479)이 위배되었습니다
INSERT INTO USER_CHECK VALUES(1,'USER02','PASS01','홍길동','M');

INSERT INTO USER_CHECK VALUES(1,'USER02','PASS01','홍길동','남');
...
-- 하나의 컬럼에 NOT NULL, UNIQUE 제약조건 둘 다 설정하고 싶다.
...
-- UNIQUE 제약조건 위배
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(MULTI.SYS_C007500)에 위배됩니다
INSERT INTO USER_PK_TABLE
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홍길동', 'M', '010-1111-1111', '2001/02/05');

INSERT INTO MEMBER
VALUES(2, 'USER02', 'PASS02', '박길동', 'F', '010-2222-2222', '2002/03/05');

INSERT INTO MEMBER
VALUES(3, 'USER03', 'PASS03', '김길동', 'M', '010-3333-3333', '2003/04/03');

INSERT INTO MEMBER
VALUES(4, 'USER04', 'PASS04', '이길동', 'M', '010-1234-5678', '2004/05/05');

INSERT INTO MEMBER
VALUES(5, 'USER05', 'PASS05', '최길동', 'F', '010-1234-2133', '2006/02/08');
...
INSERT INTO MEMBER
VALUES(1,'USER01','PASS01','홍길동','F','010-1111-2222',TO_DATE('000303','RRMMDD'));
...
-- 컬럼레벨      [] 는 생략 가능하다는 뜻!
-- [CONSTRAINT 제약조건명] REFERENCES 참조할테이블명[(참조할 컬럼)] [삭제옵션]
...
CREATE TABLE USER_FOREIGN_KEY(
	...
	GRADE_CODE NUMBER,
	CONSTRAINT FK_GRADECODE FOREIGN KEY(GRADE_CODE)
	REFERENCES USER_GRADE(GRADE_CODE) ON DELETE SET NULL   -- 만약 참조하는 데이터가 삭제되면 널로 바뀌게끔
);
...
AS SELECT EMP_ID, EMP_NAME "NAME", SALARY "급여" FROM EMPLOYEE;ALTER 
