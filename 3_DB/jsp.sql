...
DELETE FROM MLPCOMMENT WHERE COMMENTNO=3;
--------------------------------------------------
--SpringMVC03
DROP TABLE MYBOARD;
...
DROP SEQUENCE SEQ_TB;
DROP TABLE TESTBOARD;

CREATE SEQUENCE SEQ_TB NOCACHE;
CREATE TABLE TESTBOARD(
	TESTNO NUMBER PRIMARY KEY,
	TESTNAME VARCHAR2(500) NOT NULL,
	TESTTITLE VARCHAR2(1000) NOT NULL,
	TESTCONTENT VARCHAR2(2000) NOT NULL,
	TESTDATE DATE NOT NULL,
	MEMNO NUMBER NOT NULL
);
INSERT INTO TESTBOARD VALUES(SEQ_TB.NEXTVAL, '관리자', 'TEST', '테스트 중입니다...', SYSDATE, 1);
SELECT * FROM TESTBOARD;

DROP SEQUENCE SEQ_TM;
DROP TABLE TESTMEMBER;

CREATE SEQUENCE SEQ_TM NOCACHE;
...
--------------------------------------------------
-- StartBoot04_MyPrac
DROP TABLE PRACMEMBER;
DROP SEQUENCE SEQ_PM;

CREATE SEQUENCE SEQ_PM NOCACHE;
CREATE TABLE PRACMEMBER(
	MEMNO NUMBER PRIMARY KEY,
	MEMID VARCHAR2(500) NOT NULL UNIQUE,
	MEMPW VARCHAR2(500) NOT NULL,
	MEMNAME VARCHAR2(500) NOT NULL,
	MEMEMAIL VARCHAR2(1000) NOT NULL,
	MEMPHONE VARCHAR2(1000) NOT NULL
);
INSERT INTO PRACMEMBER
VALUES(SEQ_PM.NEXTVAL, 'ADMIN', '1234', '관리자', 'ADMIN@MULTI.COM', '010-1111-1111');
SELECT * FROM PRACMEMBER;