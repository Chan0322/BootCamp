...
public class Run {
	...
	public static void main(String[] args) {
		...
		emp[0] = new Employee();
		emp[1] = new Employee(1,"이창진",20,'M',"01012345678","경기 하남");
		emp[2] = new Employee(2,"강말순","교육부","강사",22,'F',1000000,0.01,"01011112222","서울 마곡");
		for(Employee e : emp) {
