...
<%
	...
	*/
	...
	/*
	request 영역
	요청을 받아서 응답하는 곳 까지 객체를 공유하는 영역.(forward 방식)
	*/
	...
	브라우저 당 1개의 session 객체 생성.
	서블릿 - request.getSession()으로 session 객체 얻을 수 있다.
	*/
	...
	/*
	application 영역
	같은 어플리케이션 내에 요청되는 모든 페이지들과 공유 하는 영역
...
%>
	...
	<br>
<%
	//pageContext.forward("res.jsp"); // request는 조건 하에 공유 가능하다.. 이렇게 forward 방식으로 이동 시 공유 가능
%>
